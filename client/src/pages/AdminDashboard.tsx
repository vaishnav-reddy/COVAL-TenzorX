            ...
            {isLoading ? (
              ...
              valuations.map((v, i) => (
                <motion.tr
                  ...
                  className="border-b border-gray-50 hover:bg-gray-50/30 transition-colors group cursor-pointer"
                ...
                >
                  ...
                  <td className="px-3 py-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded bg-gray-50 flex items-center justify-center shrink-0">
                        <Building2 className="w-3 h-3 text-[#111]" />
                      </div>
                      <div>
                  ...
                  <td className="px-3 py-2.5 text-center">
                    <button
                      ...
                      className="p-1 rounded hover:bg-gray-100 text-[#111] transition-colors"
                    >
